...
class Tracking(object):
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = 'console',
                 config=None, resume_run_id: str = None):
        ...
        if 'tracking' in default_backend or 'wandb' in default_backend:
            ...
            if resume_run_id:
                # Resume existing run so metrics are appended to the same wandb chart
                wandb.init(project=project_name, id=resume_run_id, resume='must')
                print(f'[Resume] Resumed wandb run: {resume_run_id}')
            else:
